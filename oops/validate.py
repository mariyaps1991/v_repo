...
sample1 = {"reservations": "filled",
           "instances": 1001}

sample2 = {"reservations": ["end"],
           "instances": 1002}

sample3 = {"reservations": {"ip1": 10,
                            "ip2": 20},
           "instances": 1003}

sample4 = {"reservations": [{"ip1": 10},
                            {"ip2": 20},
                            {"ip1": 30}],
           "instances": 1004}

sample5 = {"reservations": {"iplist": [{"ip1": 10},
                                        {"ip2": 20}]},
           "instances": 1005}
...
pattern = "reservations_ip1"
root_dict = sample5
#pattern = "Reservations_Groups"
#root_dict = sample6
result = find_without_skip(root_dict, pattern)
print("Actual: ", result["ip1"])
